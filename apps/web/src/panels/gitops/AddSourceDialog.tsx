    ...
    <>
      ...
      <DialogBody className="flex flex-col gap-3">
        ...
        <input
          ...
          spellCheck={false}
          className="text-xs"
          style={{ padding: "8px 10px", borderRadius: 8, background: "#08080A", border: "1px solid #26272B", color: "var(--fg-primary)", fontFamily: "ui-monospace, monospace", outline: "none" }}
        />
          ...
          {deployments.map((d, i) => (
            <li key={d.path} className="flex items-center gap-2 rounded-lg px-2 py-1.5" style={{ background: "#08080A", border: "1px solid #26272B" }}>
              ...
              <input
                ...
                spellCheck={false}
                className="text-xs"
                style={{ width: 140, background: "transparent", border: "none", color: "var(--fg-primary)", fontFamily: "ui-monospace, monospace", outline: "none" }}
              />
