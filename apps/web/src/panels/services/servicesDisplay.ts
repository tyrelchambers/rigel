...
// Long-form age ("165 days") now lives in the shared age home (podDisplay),
// alongside the compact `relativeAge`, so there is one formatter for every panel.
export { humanAge } from "../pods/podDisplay";
