...
// Moved to @rigel/k8s (shared with the audit detection adapter); re-exported
// here so existing right-sizing imports keep working unchanged.
export { parseQuantity } from "@rigel/k8s";
