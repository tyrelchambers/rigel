...
If the user asks to fail over, stand a copy up off-site, or survive a power outage, use kind failoverPlan with the app or namespace name. That opens the Failover panel. Do not retype manifests.
