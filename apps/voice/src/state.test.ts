...
describe("applyDataFrame", () => {
  test("rigel.state from the desktop sets activeContext", () => {
    const state = emptySessionState();
    applyDataFrame(state, DESKTOP_IDENTITY, "rigel.state", JSON.stringify({ activeContext: "prod" }));
  ...
  test("rigel.state from the desktop can clear activeContext to null", () => {
    ...
    applyDataFrame(state, DESKTOP_IDENTITY, "rigel.state", JSON.stringify({ activeContext: null }));
